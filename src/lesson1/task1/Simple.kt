 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = 4.445 * (vershoks + arshins * 16 + sagenes * 48) / 100.0
...
fun thirdDigit(number: Int): Int {
    val threeRightDigits : Int = number % 1000
    return threeRightDigits / 100
}
